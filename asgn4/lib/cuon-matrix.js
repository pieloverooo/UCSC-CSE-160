...
Matrix4.prototype.multiplyVector3 = function(pos) {
  var e = this.elements;
  console.log("rotmatrix", e);
  var p = pos.elements;
  var v = new Vector3();
  var result = v.elements;
  console.log("pos elements", p[0]);
  result[0] = p[0] * e[0] + p[1] * e[4] + p[2] * e[ 8] + e[12];
  console.log("thing", result[0]);
  result[1] = p[0] * e[1] + p[1] * e[5] + p[2] * e[ 9] + e[13];
  result[2] = p[0] * e[2] + p[1] * e[6] + p[2] * e[10] + e[14];
  console.log("v elements", v.elements);
...
class Vector3 {
    ...
    static dot(other1, other2) {
        ...
        for (i = 0; i < 3; ++i){
            ...
            d += v1[i]*v2[i];
            //console.log("v1[i] * v2[i] = ", v1[i]*v2[i]);
            //console.log("d: ", d);
        }
        // Don't delete the return statement.
        return d;
    ...
    magnitude() {
        ...
        // Insert your code here.
        d = this.elements;
        sum = 0; // Modify this line to calculate this vector's magnitude.
        for(i = 0; i < 3; ++i) {
            sum += d[i] * d[i];
        }
        m = Math.sqrt(sum);
